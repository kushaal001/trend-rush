  ...
  return (
    <div className="w-64 h-full bg-gray-100 border-r pt-4">
      ...
      <nav className="space-y-2">
        <MenuItem title="Home">
          <Link href="/dashboard/home/orders" className="block py-1 text-sm text-gray-700 hover:underline">Orders</Link>
          <Link href="/dashboard//home/subscribers" className="block py-1 text-sm text-gray-700 hover:underline">Subscribers</Link>
        </MenuItem>

        <MenuItem title="Catalog">
          <Link href="/dashboard/catalog/products" className="block py-1 text-sm text-gray-700 hover:underline">Products</Link>
        </MenuItem>
